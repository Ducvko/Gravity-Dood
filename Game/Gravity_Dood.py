...
def main():
    ...
    bg = pygame.image.load(os.getcwd().replace("\\dist\\Gravity_Dood", "") + "\\" + os.path.join('Assets', 'bg.png'))
    ...
    pygame.mixer.music.load(os.getcwd().replace("\\dist\\Gravity_Dood", "") + "\\" + os.path.join('Assets', 'Jetpack Joyride Main Theme.oggvorbis.ogg'))
    ...
    instructions = 'file:///' + os.getcwd().replace("\\dist\\Gravity_Dood", "") + "\\" + os.path.join('Assets', 'Instructions.html')
    ...
    with open(os.getcwd().replace("\\dist\\Gravity_Dood", "") + "\\" + os.path.join('Assets', 'Collidables', 'Limit.json'), 'r') as f:
        Limit = json.load(f)
        ...
        if game_state == 'Game':
            ...
            for current_trap in traps:
                ...
                if pygame.Rect.colliderect(player_hitbox, trap_hitbox):
                    ...
                    with open(os.getcwd().replace("\\dist\\Gravity_Dood", "") + "\\" + os.path.join('Assets', 'Highscore.json'), 'r') as f:
                        ...
                        if score_file['highscore'] == '\n':
                            with open(os.getcwd().replace("\\dist\\Gravity_Dood", "") + "\\" + os.path.join('Assets', 'Highscore.json'), 'w') as j:
